...
gulp.task('hb_qrcode-batch', buildJsxES6.bind(this, 'hb_qrcode/batch.jsx', 'hb_qrcode/batch.js'));

gulp.task('min_qrcode',miniJS.bind(this, 'hb_qrcode','qrcode.js'));
gulp.task('min_batch',miniJS.bind(this, 'hb_qrcode','batch.js'));
//----------ES6 end--------------------------

gulp.task('browserify:watch', function() {
	// -----------------------ES6 start------------------------------------
	gulp.watch('src/jsx/hb_qrcode/qrcode.jsx', ['hb_qrcode-qrcode']);
	gulp.watch('src/jsx/hb_qrcode/batch.jsx', ['hb_qrcode-batch']);
	gulp.watch('static/js/hb_qrcode/qrcode.js', ['min_qrcode']);
	gulp.watch('static/js/hb_qrcode/batch.js', ['min_batch']);
